...
function love.load()
	...
	--the state of the ball; can be any of the following:
	--1. 'serving' (only right before a player serves and before the ball collides with a player)
	--2. 'right' if the ball is going right
	--3. 'left' if the ball is going left
	ballDirection = 'serving'
end
...
function love.update(dt)
    if gameState == 'serve' then
		...
		--update ball direction to 0
		--indicating that a player is serving
		ballDirection = 'serving'
